...
public class ninja_audio : MonoBehaviour {
    ...
    {
        is_walking = false;
        audio_source.clip = audio_dash_array[rand.Next(0, audio_dash_array.Length)];
        audio_source.Play();
    }
    ...
    {
        is_walking = false;
        audio_source.clip = audio_jump_array[rand.Next(0, audio_jump_array.Length)];
        audio_source.Play();
    }
    ...
    {
        is_walking = false;
        audio_source.clip = audio_attack_weak_array[rand.Next(0, audio_attack_weak_array.Length)];
        audio_source.Play();
    }
    ...
    {
        is_walking = false;
        audio_source.clip = audio_tp_cast;
        audio_source.Play();
    }
    ...
    {
        is_walking = false;
        audio_source.clip = audio_tp_reappear;
        audio_source.Play();
    }
    ...
    void Update()
    {
        if (is_walking)
        {
            ...
            {
                time = 0.0f;
                audio_source.clip = audio_step_array[rand.Next(0, audio_step_array.Length)];
                audio_source.Play();
            }
        }
    }
